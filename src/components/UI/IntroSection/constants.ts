...
// For desktop
export const desktopHeaderPhrase = ["Introducing compadre's Next-", 'Gen Cards'];
export const desktopParagraphPhrase = [
  " Discover compadre's latest innovation – our new cards. Elevate your banking",
  'experience with cutting-edge features, security, and unprecedented',
  'convenience.',
];

// For mobile
export const mobileHeaderPhrase = ["Introducing compadre's", 'Next-Gen Cards'];
export const mobileParagraphPhrase = [
  " Discover compadre's latest innovation – our new cards.",

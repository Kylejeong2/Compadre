...
export const desktopHeaderPhrases = [
  ...
  'Journey with compadre',
];
export const desktopParagraphPhrase = [
  'compadre offers a world of financial possibilities. From investments to payments,',
  "we've got you covered. Join us and unlock your potential today.",
];

// For mobile
export const mobileParagraphPhrase = [
  'compadre offers a world of financial possibilities. From',
